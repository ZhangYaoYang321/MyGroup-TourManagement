<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="游客姓名" prop="visitorsName">
        <el-input
          v-model="queryParams.visitorsName"
          placeholder="请输入游客姓名"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:visitors:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:visitors:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:visitors:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:visitors:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="visitorsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="游客姓名" align="center" prop="visitorsName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="游客姓名" prop="visitorsName">
          <el-input v-model="form.visitorsName" placeholder="请输入游客姓名" />
        </el-form-item>
        <el-form-item label="手机号" prop="phoneNumber">
...
<script>
import { listVisitors, getVisitors, delVisitors, addVisitors, updateVisitors } from "@/api/system/visitors";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/visitors/export', {
        ...this.queryParams
