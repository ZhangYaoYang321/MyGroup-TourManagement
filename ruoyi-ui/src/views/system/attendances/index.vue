  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="考勤状态" prop="stateWorking">
        <el-input
          v-model="queryParams.stateWorking"
          placeholder="请输入考勤状态"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:attendances:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:attendances:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['system:attendances:export']"
        >导出</el-button>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listAttendances(this.queryParams).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/attendances/export', {
        ...this.queryParams
      }, `attendances_${new Date().getTime()}.xlsx`)
    }
  }
};
</script>
