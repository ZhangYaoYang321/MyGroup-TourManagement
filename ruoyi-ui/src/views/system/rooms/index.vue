<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="入住情况" prop="stateRoom">
        <el-input
          v-model="queryParams.stateRoom"
          placeholder="请输入入住情况"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="roomsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="入住情况" align="center" prop="stateRoom" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="入住情况" prop="stateRoom">
          <el-input v-model="form.stateRoom" placeholder="请输入入住情况" />
        </el-form-item>
      </el-form>
...
<script>
import { listRooms, getRooms, delRooms, addRooms, updateRooms } from "@/api/system/rooms";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/rooms/export', {
        ...this.queryParams
